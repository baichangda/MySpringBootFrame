...
public class OkHttpConfig {
    ...
    public static void main(String[] args) throws IOException {
        final HttpUrl.Builder httpBuilder = HttpUrl.parse("https://fanyi.baidu.com/v2transapi").newBuilder();
        httpBuilder.addQueryParameter("from", "zh");
        httpBuilder.addQueryParameter("to", "en");
