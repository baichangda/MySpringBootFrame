...
public class ShiroMessageDefine {
    ...
    public final static ErrorMessage ERROR_SHIRO_UNAUTHORIZED = ErrorMessage.getMessage("权限不足").code(String.valueOf(HttpServletResponse.SC_UNAUTHORIZED));
    ...
    public final static ErrorMessage ERROR_SHIRO_UNKNOWN_SESSION = ErrorMessage.getMessage("未知的会话,请重新登录");
    public final static ErrorMessage ERROR_SHIRO_EXPIRED_SESSION= ErrorMessage.getMessage("会话已过期,请重新登陆");
}
