...
public @interface Table {
    ...
    /**
     * 当bean继承{@link com.bcd.base.support_jdbc.bean.BaseBean}时候才有效
     * 默认开启
     * 此属性指定是否在新增时候自动设置创建信息、影响的方法如下
     ...
     * 当bean继承{@link com.bcd.base.support_jdbc.bean.BaseBean}时候才有效
     * 默认开启
     * 此属性指定是否在更新时候自动设置更新信息、影响的方法如下
     * {@link com.bcd.base.support_jdbc.service.BaseService#update(SuperBaseBean)}
     * {@link com.bcd.base.support_jdbc.service.BaseService#update(long, ParamPairs...)}
